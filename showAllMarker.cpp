...
//--------------------------------------------------------------
void showAllMarker::drawAR(int markerID){
	if(markerID==10)
	{
		glPushMatrix();
			ofSetLineWidth(5);
...
//--------------------------------------------------------------
void showAllMarker::keyPressed(int key){
	if(key == OF_KEY_UP) {
		artk.setThreshold(++threshold);
...
//--------------------------------------------------------------
void showAllMarker::keyReleased(int key){

}

//--------------------------------------------------------------
void showAllMarker::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void showAllMarker::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void showAllMarker::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void showAllMarker::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void showAllMarker::windowResized(int w, int h){
